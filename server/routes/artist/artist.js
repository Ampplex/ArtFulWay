...
const { getMatchedProjects, acceptProject, getAcceptedProjects, getProjectDetails, submitProject, getArtistName, getArtistDetails } = require("../../controllers/dashboard/artist");
